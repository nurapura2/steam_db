...
//---------------------------------------------------
// ✅ Универсальный менеджер TinyMCE
//---------------------------------------------------
// const TinyManager = {
//     init(id = "content") {
//         if (typeof tinyMCE === "undefined") return;
//         const old = tinyMCE.get(id);
//         if (old) return; // уже инициализирован
//
//         tinyMCE.init({
//             mode: "exact",
//             elements: id,
//             theme: "advanced",
//             plugins: "emotions,link,image,code",
//             theme_advanced_buttons1:
//                 "bold,italic,underline,|,bullist,numlist,|,link,unlink,image,code,|,forecolor,removeformat,|,emotions",
//             theme_advanced_toolbar_location: "top",
//             theme_advanced_toolbar_align: "left",
//             theme_advanced_resizing: true,
//             entity_encoding: "raw",
//             content_css: "/common/tinymce/css/tinymce_mb.css"
//         });
//     },
//
//     destroy(id = "content") {
...
function initTinyMCEEditor(ids = []) {
    tinyMCE.init({
        theme : "advanced",
        mode: ids.length ? "exact" : "textareas", // если передан список id — активируем только их
        elements: ids.join(","),                  // превращаем массив в строку через запятую
        plugins : "emotions",
        theme_advanced_buttons1 : "bold,italic,underline,title,link,unlink,image,forecolor,styleselect,removeformat,cleanup,|,bullist,numlist,|, emotions",
        ...
        theme_advanced_resizing : true,
        content_css : "css/tinymce_mb.css",
        ...
        theme_advanced_resizing_max_height : 450,
        theme_advanced_resizing_max_width : 650,
        theme_advanced_resizing_use_cookie : true,
        // Style formats
        /*style_formats : [
            {title : 'Qalın yazı', inline : 'b'},
            {title : 'Qırmızı yazı', inline : 'span', styles : {color : '#ff0000'}},
            {title : 'Qırmızı başlıq', block : 'h1', styles : {color : '#ff0000'}},
            {title : 'Nümunə 1', inline : 'span', classes : 'example1'},
            {title : 'Nümunə 2', inline : 'span', classes : 'example2'}
        ],*/
        entity_encoding : "raw",
